    ...
    <main class="visas-main">
        ...
        <div class="visas-grid">
          ...
          <div class="visa-card">
            ...
            <div class="visa-card-body">
              ...
              <div class="visa-info">
                <span class="processing-time">⏱ 5-7 days</span>
              </div>
            </div>
          </div>
          ...
          <div class="visa-card">
            ...
            <div class="visa-card-body">
              ...
              <div class="visa-info">
                <span class="processing-time">⏱ 10-14 days</span>
              </div>
            </div>
          </div>
          ...
          <div class="visa-card">
            ...
            <div class="visa-card-body">
              ...
              <div class="visa-info">
                <span class="processing-time">⏱ 5-10 days</span>
              </div>
            </div>
          </div>
          ...
          <div class="visa-card">
            ...
            <div class="visa-card-body">
              ...
              <div class="visa-info">
                <span class="processing-time">⏱ 3-5 days</span>
              </div>
            </div>
          </div>
          ...
          <div class="visa-card">
            ...
            <div class="visa-card-body">
              ...
              <div class="visa-info">
                <span class="processing-time">⏱ 7-10 days</span>
              </div>
            </div>
          </div>
          ...
          <div class="visa-card">
            ...
            <div class="visa-card-body">
              <span class="visa-badge-new">New</span>
              <h3><a href="#azerbaijan">Azerbaijan Visa</a></h3>
              <div class="visa-info">
                <span class="processing-time">⏱ 5-10 days</span>
              </div>
            </div>
          ...
          <div class="visa-card">
            ...
            <div class="visa-card-body">
              <h3><a href="#uganda">Uganda Visa</a></h3>
              <div class="visa-info">
                <span class="processing-time">⏱ 5-7 days</span>
              </div>
            </div>
      ...
      <section class="visas-section" id="travel-abroad">
        <div class="section-header">
          ...
          <p>Fast, easy, and secure international visa application. Apply now and get ready to travel!</p>
        </div>

        <div class="visas-grid">
          <!-- Travel Abroad Visa Cards -->
          <div class="visa-card">
            <div class="visa-card-image">
              <div class="visa-flag">🇦🇺</div>
            </div>
            <div class="visa-card-body">
              ...
              <div class="visa-info">
                <span class="processing-time">⏱ 10-15 days</span>
              </div>
            </div>
          </div>
          ...
          <div class="visa-card">
            ...
            <div class="visa-card-body">
              <span class="visa-badge">5 Reviews</span>
              <h3><a href="#uk">UK Visa</a></h3>
              <div class="visa-info">
                <span class="processing-time">⏱ 15-30 days</span>
              </div>
            </div>
          </div>
          ...
          <div class="visa-card">
            ...
            <div class="visa-card-body">
              ...
              <div class="visa-info">
                <span class="processing-time">⏱ 15-20 days</span>
              </div>
            </div>
          </div>
          ...
          <div class="visa-card">
            ...
            <div class="visa-card-body">
              <span class="visa-badge-new">New</span>
              <h3><a href="#ethiopia">Ethiopia Visa</a></h3>
              <div class="visa-info">
                <span class="processing-time">⏱ 5-7 days</span>
              </div>
            </div>
          ...
          <div class="visa-card">
            ...
            <div class="visa-card-body">
              ...
              <div class="visa-info">
                <span class="processing-time">⏱ 20-45 days</span>
              </div>
            </div>
          </div>
          ...
          <div class="visa-card">
            ...
            <div class="visa-card-body">
              <h3><a href="#russia">Russia Visa</a></h3>
              <div class="visa-info">
                <span class="processing-time">⏱ 10-15 days</span>
              </div>
            </div>
      ...
      <section class="visas-section visa-categories">
        <div class="section-header">
          <h2>Explore Visa by Traveler Category</h2>
          <p>Find visa information tailored to your traveler type</p>
        </div>

        <div class="categories-grid">
          <div class="category-card">
            <div class="category-icon">🇮🇳</div>
            <h3>Visa for Indians</h3>
            <p>Special visa programs for Indian passport holders</p>
            <a href="#" class="category-link">Explore →</a>
          </div>

          <div class="category-card">
            <div class="category-icon">🇦🇪</div>
            <h3>Visa for UAE residents</h3>
            <p>Visa options for residents of the United Arab Emirates</p>
            <a href="#" class="category-link">Explore →</a>
          </div>

          <div class="category-card">
            <div class="category-icon">🇸🇦</div>
            <h3>Visa for Saudi Nationals</h3>
            <p>Travel visa programs for Saudi Arabian nationals</p>
            <a href="#" class="category-link">Explore →</a>
          </div>
        </div>
      </section>
